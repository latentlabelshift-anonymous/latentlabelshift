...
class Dataset:
    def __init__(self, dataset_seed, batch_size=32):
        train_data, valid_data, test_data, train_loader, valid_loader, test_loader, n_train, n_test, n_valid, data_dims, total_pixels_per_image, n_classes = self.get_data(batch_size, dataset_seed=dataset_seed)
    ...
    def get_data(self, batch_size, dataset_seed):
        pass
...
Modified by anonymous authors
"""
class ImageNet(datasets.ImageFolder):
    def __init__(self, root=('root_folder'), split='train', transform=None):
...
class ImageNetSubset(data.Dataset):
    def __init__(self, subset_file, root=('root_folder'), split='train', 
                    transform=None):
...
class ImageNet50(Dataset):
    def get_data(self, batch_size, dataset_seed):
        ...
        train_base = ImageNetSubset(subset_file='imagenet_50.txt', split='train', transform=transforms.Compose([
        ...
        test_data = ImageNetSubset(subset_file='imagenet_50.txt', split='val', transform=transforms.Compose([
                                        transforms.Resize(256),
                                        transforms.CenterCrop(224),
                                        transforms.ToTensor(),
                                        transforms.Normalize(mean, std),
        ...
        print('Imagenet', n_train, n_valid, n_test)
...
class CIFAR10(Dataset):
    def get_data(self, batch_size, dataset_seed):
        ...
        train_base = torchvision.datasets.CIFAR10('~/cifar10/', train=True, download=True, transform=transforms.Compose([
...
class CIFAR100(Dataset): 
    def get_data(self, batch_size, dataset_seed):
        ...
        train_base = torchvision.datasets.CIFAR100('~/cifar100/', train=True, download=True, transform=torchvision.transforms.ToTensor())
...
class CIFAR100Coarse(torchvision.datasets.CIFAR100):
    def __init__(self,root,train,download,transform):
        ...
        self.targets = list(coarse_labels[self.targets]) # coarse_labels can be found in experiment_utils
...
class CIFAR20(Dataset): 
    def get_data(self, batch_size, dataset_seed):
        ...
        train_base = CIFAR100Coarse('~/cifar100/', train=True, download=True, transform=transforms.Compose([
                                    transforms.RandomResizedCrop(32),
                                    transforms.RandomHorizontalFlip(),
                                    torchvision.transforms.ToTensor(),
                                    torchvision.transforms.Normalize(mean=cifar_100_mean, std=cifar_100_std)
        ...
        test_data = CIFAR100Coarse('~/cifar100/', train=False, download=True,
                                    transform=torchvision.transforms.Compose([
                                    transforms.CenterCrop(32),
                                    torchvision.transforms.ToTensor(),
                                    torchvision.transforms.Normalize(mean=cifar_100_mean, std=cifar_100_std),
...
class FieldGuide2(Dataset):
    def get_data(self, batch_size, dataset_seed):
        ...
        fieldguide2_directory = '~/fieldguide2/'
